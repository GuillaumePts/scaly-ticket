...
def build_job_sliced(image):
    ...
    sg_commands = b""
    CHUNK_H = 300 # On coupe tous les 300 points (limite memoire imprimante)
    ...
    for y in range(0, img_h, CHUNK_H):
        ...
        # X=0016 pour l'offset de 2mm. Y=y pour placer le chunk au bon endroit.
        sg = f"{{SG;0016,{y:04d},{img_w:04d},{chunk_h:04d},3,".encode('ascii')
        clen = len(comp)
...
if __name__ == '__main__':
    ...
    if '--print' in sys.argv:
        ...
        print("Envoye V7 (Slidced - Decoupe en blocs de 300)")
