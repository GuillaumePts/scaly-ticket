...
def draw_single_label(data: dict) -> Image.Image:
    # Paysage: 920 dots (W) x 240 dots (H) pour pivoter en 240x920
    img_w, img_h = 920, 240
...
def build_job_factory_match(image):
    img_w, img_h = image.size
    
    # EXACT HEADER FROM FACTORY exemplePrn.prn
    header = (
        b"<xpml><page quantity='0' pitch='120.1 mm'></xpml>\r\n"
        b"{D1221,0975,1201|}\r\n"
        b"<xpml></page></xpml>\r\n"
        b"<xpml><page quantity='1' pitch='120.1 mm'></xpml>\r\n"
        b"{C|}\r\n"
    )
    
    sg_commands = b""
    CHUNK_H = 300 # Exactement comme le fichier PRN d'usine
    ...
    for y in range(0, img_h, CHUNK_H):
        ...
        # X=0024 exactement comme le fichier d'usine (3mm offset)
...
if __name__ == '__main__':
    ...
    if '--print' in sys.argv:
        try:
            ...
            print("Envoyé avec succès avec les parametres usine !")
        except Exception as e:
            print(f"Erreur: {e}")
    else:
        print("Fichier pret, lancez avec --print")
