...
def draw_single_label(libelle, gtin, date_expiration, lot) -> Image.Image:
    ...
    try:
        ...
        font_normal = ImageFont.truetype("arialbd.ttf", 28)
...
if __name__ == '__main__':
    img = draw_single_label("6 Yaourt err Abricot RGFX125G", "13374270830099", "260712", "26L222805")
    img.save("scratch_label2.png")
    print("Label saved to scratch_label2.png")
